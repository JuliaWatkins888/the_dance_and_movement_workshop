...
// existing frontend import from @inithium/db is `import type` only (see UserFormDialog's own
// CORE_ROLES mirror in the CMS package for the identical reason: @inithium/db's barrel also
// re-exports the Mongo provider, which a runtime import would pull into the client bundle).
